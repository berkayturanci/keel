...
- **Evidence Gate Reported Green While Waiting** (#928):
  ...
  - `docs/keel/evidence.md` now describes the shipped behaviour, and `tests/test_evidence_gate_workflow.py` asserts each `case` arm's own status and conclusion so a swapped or hardcoded verdict cannot pass.
