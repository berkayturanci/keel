...
Use this skill when the user asks to run the keel command `morning` (e.g. `keel morning ...`, `morning <args>`, or `/keel:morning`). It reads every project value from `.keel/project.yaml` via the `keel` CLI.
...
<!-- keel-generated: surface=skills command=morning keel_version=1.17.0 source_sha256=5bcd4d2e1d791805237934d8333fa14283bf5bac184020b71fdfdcd80fd25b65 generated_sha256=77bc61d980e8725c9684cb0e42d01a8cce02f9fafd79a891ce4cb52072e2dd5a -->
