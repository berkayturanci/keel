...
Use this skill when the user asks to run the keel command `review-all-day` (e.g. `keel review-all-day ...`, `review-all-day <args>`, or `/keel:review-all-day`). It reads every project value from `.keel/project.yaml` via the `keel` CLI.
...
<!-- keel-generated: surface=skills command=review-all-day keel_version=1.13.0 source_sha256=a869b7917f756a31b726c0bff423cf44cbed7573cd4eaf66e3dfb2ab09cf28eb generated_sha256=f7807345c19b1d7b9b2c0816576d5cbd6b2a93e547d2c6dcc3008c6749adee2b -->
