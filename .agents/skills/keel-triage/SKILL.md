...
Use this skill when the user asks to run the keel command `triage` (e.g. `keel triage ...`, `triage <args>`, or `/keel:triage`). It reads every project value from `.keel/project.yaml` via the `keel` CLI.
...
<!-- keel-generated: surface=skills command=triage keel_version=1.13.0 source_sha256=5323541c69418c01b9fee083f7e4d79cdad44f030b23fadd538fc334ed2abf7e generated_sha256=db6420bc76dfaa7e46ff6b11cfac19ef366e0bec02ecd6620a7c7006c54a5070 -->
