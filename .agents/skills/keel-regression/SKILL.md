...
Use this skill when the user asks to run the keel command `regression` (e.g. `keel regression ...`, `regression <args>`, or `/keel:regression`). It reads every project value from `.keel/project.yaml` via the `keel` CLI.
...
<!-- keel-generated: surface=skills command=regression keel_version=1.11.0 source_sha256=0c293379fc0d500d0df8951d6b41a9b055590575b909e4582c23572ee90965fd generated_sha256=d943ce80f8dd65f766b50e493c2d18d874234b74b73b113c6e45b0e9ada45831 -->
