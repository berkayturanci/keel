  ...
  docs: [
    ...
    },
    {
      ...
      body:
        ...
        "<p>It composes with the <b>cross-vendor jury</b>: <code>--follow</code> shows the jury status live, and <code>--theater</code> hands the screen to <a href='https://github.com/berkayturanci/ai-jury' target='_blank' rel='noopener'>ai-jury</a>'s deliberation theater at the review step, then resumes from the live checkpoint. Fail-soft and dependency-free — keel-visual never imports ai-jury, and if the <code>jury</code> CLI is absent the jury simply doesn't animate and nothing errors.</p>",
