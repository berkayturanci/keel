  ...
  docs: [
    ...
    },
    {
      ...
      body:
        ...
        "<p><b>Each has its own <i>update</i> path, and none of them is a re-install</b> — <code>/plugin install</code> is a no-op on an already-installed plugin. All four, with what each route registers, are in <a href='https://github.com/berkayturanci/keel/blob/main/docs/keel/install.md'>docs/keel/install.md</a>.</p>" +
