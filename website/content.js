...
window.KEEL = {
  ...
  cli: [
    ...
    ["keel swarm-plan --issues 12,15", "cluster backlog issues into disjoint execution waves and compute batch vs funnel landing plan"],
    ["keel swarm-status <cfg>", "real-time multi-cluster execution snapshot, worker health, and DAG progress"],
    ["keel swarm-run --issues 12,15", "orchestrate parallel workers in isolated worktrees with dynamic rebalancing"],
    ["keel swarm-land --wave 1", "dual-mode batch landing under merge lock with self-healing conflict rollback"],
