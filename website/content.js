...
window.KEEL = {
  meta: {
    ...
    installAlt: "pip install \"git+https://github.com/berkayturanci/keel@v1.22.0\"",
  ...
  docs: [
    ...
    },
    {
      ...
      body:
        ...
        "<pre class='doc-pre' tabindex='0' role='region' aria-label='Codex, Antigravity and Cursor plugin commands'><code>codex plugin marketplace add https://github.com/berkayturanci/keel\ncodex plugin add keel@keel\n\nagy plugin install https://github.com/berkayturanci/keel   <span class='cm'># then: agy plugin enable keel</span>\n\ncursor-agent plugin marketplace add https://github.com/berkayturanci/keel</code></pre>" +
        "<p><b>Each has its own <i>update</i> path, and they are not the same shape</b>: re-running the install is the update for Antigravity and Codex, while in Claude Code <code>/plugin install</code> is a no-op on an installed plugin and <code>plugin update keel@keel</code> is the command. All four, with what each route registers, are in <a href='https://github.com/berkayturanci/keel/blob/main/docs/keel/install.md'>docs/keel/install.md</a>.</p>" +
