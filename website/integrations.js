...
(function () {
  ...
  var INTEGRATIONS = [
    ...
    // --- 4. Platforms & Environments (6) ---
    {
      ...
      desc: "Official composite action (berkayturanci/keel@v1.23.0) for gates, ship assessment, evidence verification and swarm planning.",
      cmd: "uses: berkayturanci/keel@v1.23.0",
