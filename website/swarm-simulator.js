...
(function () {
  ...
  function renderUI() {
    ...
    html.push(
      ...
      '        <span>Speed:</span>',
      '        <button type="button" class="sim-speed-btn ' + (state.speed === 1 ? 'active' : '') + '" data-speed="1" aria-label="Animation speed 1×">1x</button>',
      '        <button type="button" class="sim-speed-btn ' + (state.speed === 2 ? 'active' : '') + '" data-speed="2" aria-label="Animation speed 2×">2x</button>',
      '        <button type="button" class="sim-speed-btn ' + (state.speed === 4 ? 'active' : '') + '" data-speed="4" aria-label="Animation speed 4×">4x</button>',
      '      </div>',
      '    </div>',
      '  </div>',
